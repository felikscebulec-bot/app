...
def run():
    ...
    y1 = st.number_input("Enter viskoznost EVA 33-400:", min_value=0, key="kolicina_y1", format="%d")
    y2 = st.number_input("Enter viskoznost EVA 33-45:", min_value=0, key="kolicina_y2", format="%d")
