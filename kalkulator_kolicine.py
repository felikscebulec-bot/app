...
#------reset button------------- 
 ...
 def load_data(path: str):
    ...
    name_map = {
        "Viskoznost EVA 33-400": "y1",
        "Viskoznost EVA 33-45": "y2",
        "Količina EVA 33-400 [kg]": "x1",
        "Količina EVA 33-45 [kg]": "x2",
...
#-----user input-----
 ...
 y1 = st.number_input("Vnesite viskoznost EVA 33-400:", min_value=0, step=1, key="visco_400", format="%d")
 y2 = st.number_input("Vnesite viskoznost EVA 33-45:", min_value=0, step=1, key="visco_45", format="%d")
